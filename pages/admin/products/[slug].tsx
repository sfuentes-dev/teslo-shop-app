...
const ProductAdminPage: FC<Props> = ({ product }) => {
  ...
  const onDeleteTag = (tag: string) => {
    const updateTag = getValues('tags').filter((t) => t !== tag);
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              {...register('title', {
                ...
                minLength: { value: 2, message: 'A min 2 characters' },
              })}
              error={!!errors.title}
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              {...register('slug', {
                required: 'This field is required',
                validate: (val) =>
                  val.trim().includes(' ') ? 'Cannot have empty spaces' : undefined,
              })}
              error={!!errors.slug}
            ...
            <TextField
              ...
              fullWidth
              sx={{ mb: 1 }}
              helperText='Push [space bar] to add'
              value={newTagValue}
            ...
            <Box display='flex' flexDirection='column'>
              ...
              <Chip
                label='A minimum of 2 images are required'
                color='error'
                variant='outlined'
